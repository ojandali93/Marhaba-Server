...
export const grabSingleProfile = async (req, res) => {
  try {
    ...
    .from('Profile')
    .select('*, About(*), Career(*), Core(*), Future(*), Habits(*), Intent(*),  Photos(*), Preferences(*), Prompts(*), Relationshps(*), Religion(*), Socials(*), Survey(*), Tags(*)')
    .eq('userId', userId)
  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .select(`
        *, 
        likerProfile:userId ( 
          *, About(*), Career(*), Core(*), Future(*), Habits(*), Intent(*),  Photos(*), Preferences(*), Prompts(*), Relationshps(*), Religion(*), Socials(*), Survey(*), Tags(*)
        )
      `)
